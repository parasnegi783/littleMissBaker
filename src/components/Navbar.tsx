...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Main Header */}
      <motion.nav
        className="sticky top-0 z-50 bg-[#FFFBF9]/95 backdrop-blur-md border-b border-pink-100"
        initial={{ y: -80 }}
        animate={{ y: 0 }}
      ...
      >
          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link to="/" className="flex items-center gap-2 group">
                <motion.div
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-[#F9E2DF] to-[#DC8B92] flex items-center justify-center border-2 border-[#DC8B92]/30 shadow-sm group-hover:shadow-md transition-shadow"
              ...
              {isLoggedIn ? (
                ...
                >
                  ...
                  <motion.div variants={{ hidden: { opacity: 0, x: 20 }, visible: { opacity: 1, x: 0 } }}>
                    <Link
                      to="/signup"
                      className="px-5 py-2 bg-[#DC8B92] hover:bg-[#B95A66] text-white text-sm font-medium rounded-full transition-all hover:shadow-md font-[Quicksand]"
                    >
                      Sign up
                    </Link>
                  </motion.div>
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div
              className="md:hidden bg-[#FFFBF9] border-t border-pink-100 shadow-lg"
